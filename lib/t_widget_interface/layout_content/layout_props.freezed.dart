...
// Image Picker Start=============================================
  String? get onResponse => throw _privateConstructorUsedError;
  String? get host =>
...
// ListTile Start================================================
  ...
  @JsonKey(ignore: true)
  $LayoutPropsCopyWith<LayoutProps> get copyWith =>
      throw _privateConstructorUsedError;
}
    ...
    return _then(_value.copyWith(
      ...
      onSelectChanged: freezed == onSelectChanged
          ...
          : onSelectChanged // ignore: cast_nullable_to_non_nullable
              as String?,
      onSelectAll: freezed == onSelectAll
          ? _value.onSelectAll
          : onSelectAll // ignore: cast_nullable_to_non_nullable
              as String?,
...
/**
  ...
  Map<String, dynamic>? get formatters {
    final value = _formatters;
    if (value == null) return null;
    if (_formatters is EqualUnmodifiableMapView) return _formatters;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }
...
// ListTile End==================================================
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('disabledBorder', disabledBorder))
      ..add(DiagnosticsProperty('focusedErrorBorder', focusedErrorBorder))
      ..add(DiagnosticsProperty('errorBorder', errorBorder))
